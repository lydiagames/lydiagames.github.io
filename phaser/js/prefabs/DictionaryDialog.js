...
class DictionaryDialog extends Dialog{
    ...
    onShowComplete(){
        ...
        /*let str = "CAT\n A small domesticated carnivorous mammal <em>(Felis catus),</em> kept as a pet and as catcher of vermin, and existing in a variety of breeds."
        this.text.setText(this.stripText(str));
