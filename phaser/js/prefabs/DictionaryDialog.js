...
class DictionaryDialog extends Dialog{
    ...
    onShowComplete(){
        for(let i = 0; i < this.words.length; i++){
            ...
            this.sendRequest.bind(this, this.words[i])
    ...
    sendRequest(word){
        ...
        xmlhttp.open("GET", "https://api.wordnik.com/v4/word.json/" + word.toLowerCase() +"/definitions?limit=1&includeRelated=false&useCanonical=false&includeTags=false&api_key=" + Config.WORDNIC_API_KEY, true);
