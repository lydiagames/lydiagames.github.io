...
class DictionaryDialog extends Dialog{
    ...
    sendRequest(word){
        ...
        let url = "https://api.wordnik.com/v4/word.json/" + word.toLowerCase() + "/definitions?limit=1&includeRelated=false&useCanonical=false&includeTags=false&api_key=" + Config.WORDNIC_API_KEY;
        console.log(url);
